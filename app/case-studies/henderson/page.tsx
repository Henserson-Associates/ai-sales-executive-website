...
export const metadata: Metadata = {
  ...
  description:
    "How a government funding advisory firm used AI agents to reach more qualified Canadian business clients.",
  alternates: {
    canonical: "/case-studies/henderson"
  }
};
...
export default function HendersonCaseStudyPage() {
  const caseStudySchema = {
    ...
    "@type": "Article",
    headline: "Professional Services - SR&ED and Government Funding Advisory",
    description:
      "How a specialized advisory firm used Leadnexa AI Agents to reach more qualified clients.",
    author: {
      "@type": "Organization",
      name: "LeadNexa.ai"
    },
    ...
    mainEntityOfPage: absoluteUrl("/case-studies/henderson")
  };
